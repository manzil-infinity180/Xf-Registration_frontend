    ...
    return (
        ...
        <header className="navbar_header">
            <div className='left_content'>
                <a href='/'>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" className='logo_navbar_f'
            ...
            target="_blank" rel="noreferrer noopener" title="X" aria-label="X link">
                ...
                <div className='sign_div'>
                    <a  href="/login" className='signin_btn'>Sign In</a>
                </div>
                <div className='sign_div'>
                    <a  href="/me" className='signin_btn'>My Profile</a>
                </div>
                {/* <div className='sign_div'>
                    <a  href="/" className='signin_btn'>About Me</a>
                </div> */}
