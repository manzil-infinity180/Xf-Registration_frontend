        ...
        <section className='section_container_login section_signin'>
          ...
          <div className='signin_content'>
            ...
            <p className='signin_description'>
                Yeah!! boii you are on correct url, you can change your username please be unique in society
            </p>
          </div>
        <div className='main_login_box'>
           <p className='login_text'>Login</p>
                ...
                <p className='login_description'>
                    If you are successfully changed your username, you will get the email for succession 
                    and also a pop message
                </p>
                <form className='form_login' onSubmit={handleSubmit}>
                    <div className='form_label'>
                    <label>Your New Username</label>
                    </div>
                    <input type='text' placeholder='Be a Unique Everywhere' 
                    autoComplete='off' 
                    name='username' >
                    </input>
                    <button type='submut'>Username</button>
                </form>
