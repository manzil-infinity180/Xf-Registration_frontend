        ...
        <div className='main_login_box'>
           <p className='login_text'>Register yourself on XF</p>
                ...
                <p className='login_description'>
                    If you are successfully logged in, you will get the email for succession.
                    It&#39;s password free registration, because reset password link sucks.
                    <p>
                    All fields are REQUIRED, except Social Links.
                    </p>
                </p>
                <form className='form_login' onSubmit={handleSubmit}>
                    <InputField name="name" placeholder="Enter your fullname" type="text" required={true} >Full Name</InputField>
                    <InputField name="email" placeholder="Enter your email address" type="email" required={true}>Email</InputField>
                    <InputField name="username" placeholder="Enter unique username" type="text" required={true} >Username</InputField>
                    <InputField name="age" placeholder="Your current Age" type="text" required={true} >Age</InputField>
                    <InputField name="summary" className="summary_class" placeholder="Introduce Your Self under 150 words" type="text" required={true} >Summary</InputField>
                    <InputField name="college" placeholder="Your College name" type="text" required={true} >College Name</InputField>
                    <InputField name="address" placeholder="Enter your address" type="text" required={true} >Address</InputField>
                    <InputField name="position" placeholder="What are you currently? Student, Developer?" type="text" required={true} >Position ?</InputField>
                    <InputField name="OneTopSkill" placeholder="Your One Top Skills" type="text" required={true} >Proficient Skills</InputField>
                    <InputField name="skills" placeholder="Your skills like nodejs, react, javascript, deveops..." type="text" required={true} >Skills</InputField>
                    <InputField name="resumeLink" placeholder="If? Resume Link" type="text" >Resume Link</InputField>
                    <InputField name="github" placeholder="If? Github Handle Username" type="text" >Github</InputField>
                    <InputField name="linkedin" placeholder="If? Linkedin Handle Link" type="text" >LinkedIn</InputField>
                    <InputField name="twitter" placeholder="If? Twitter Handle Link" type="text" >Twitter</InputField>
                    <InputField name="leetcode" placeholder="If? Leetcode Handle Username" type="text" >Leetcode</InputField>
                    <InputField name="codeforces" placeholder="If? Codeforces Handle Username" type="text" >Codeforce</InputField>
                    <button type='submit'>Register Me</button>
                </form>

               <ContinueWith firstField={'Github'} firstPath={'/'} secondField={"Login?"} secondPath={'/login'} />
