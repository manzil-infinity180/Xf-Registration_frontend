...
function Header() {
  return (
    <>
      <section
        className="section_container_login section_signin"
        style={{
          marginTop: "250px",
      ...
      >
        <h1 className="title_header">
          Your Review/Suggestion for this Project
        </h1>
        <p className="p_header">
          Please ping me a message what thing i can improve and what thing that
          you like and if you want to contribute in this project just create
          issue and raise a pr for that.Click on <b>suggestion</b> and fill the
          form
        </p>
        <svg
        ...
        <h1 className="logo_name">
          e<span>X</span>tremely <span>f</span>rustrated
        </h1>
        <h4
          style={{
        ...
        >
          <a
            href={"https://github.com/manzil-infinity180"}
          ...
          >
            <svg
              stroke="currentColor"
              style={{ margin: "0 3rem", fontSize: "1.5rem" }}
              fill="#ffff"
              strokeWidth="0"
              viewBox="0 0 496 512"
              height="1em"
          ...
          <a
            href="https://twitter.com/manzil_rahul"
            className="header_logo"
            target="_blank"
            rel="noreferrer noopener"
            title="X"
        ...
        >
          <a href="https://rahulxf.tech" style={{ textDecoration: "none" }}>
            <h1 className="h1_header">About Me</h1>
          </a>
          <a
            href="https://github.com/manzil-infinity180/Xf-Registration"
            style={{ textDecoration: "none" }}
          >
            <h1 className="h1_header">Contribute</h1>
          </a>
          <a
            href="https://forms.gle/yz9WJEHkm7ahvu4o9"
            style={{ textDecoration: "none" }}
          >
