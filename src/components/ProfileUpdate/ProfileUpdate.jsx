...
export function ProfileUpdate() {
    ...
    return (
        ...
        <section className='section_container_login section_signin'>
          ...
          <div className='signin_content'>
            ...
            <p className='signin_description'>
                Here you can update all details except,email and username & for username click on Update Username
            </p>
          </div>
        ...
        <form className='form_login' onSubmit={handleSubmit}>
                   { 
                    data && <>
                    <InputFieldUpdate name="name" placeholder="Enter your fullname" type="text" required={true} 
                     value={data.name}>Full Name</InputFieldUpdate>
                    <InputFieldUpdate name="email" placeholder="Enter your email address" type="email" required={true} 
                    disabled={true} value={data.email}>Email</InputFieldUpdate>
                    <InputFieldUpdate name="username" placeholder="Enter unique username" type="text" required={true}  
                    disabled={true} value={data.username} >Username</InputFieldUpdate>
                    <InputFieldUpdate name="age" placeholder="Your current Age" type="text" required={true} 
                    value={data.age} >Age</InputFieldUpdate>
                    <InputFieldUpdate name="summary" className="summary_class" placeholder="Introduce Your Self under 150 words" type="text"required={true} 
                    value={data.summary} >Summary</InputFieldUpdate>
                    <InputFieldUpdate name="college" placeholder="Your College name" type="text" required={true} 
                    value={data.college} >College Name</InputFieldUpdate>
                    <InputFieldUpdate name="address" placeholder="Enter your address" type="text" required={true} 
                    value={data.address} >Address</InputFieldUpdate>
                    <InputFieldUpdate name="position" placeholder="What are you currently? Student, Developer?" type="text" required={true} 
                    value={data.position} >Position ?</InputFieldUpdate>
                    <InputFieldUpdate name="OneTopSkill" placeholder="Your One Top Skills" type="text" required={true} 
                    value={data.OneTopSkill} >Proficient Skills</InputFieldUpdate>
                    <InputFieldUpdate name="skills" placeholder="Your skills like nodejs, react, javascript, deveops..." type="text" required={true} 
                    value={data.skills} >Skills</InputFieldUpdate>
                     <InputFieldUpdate name="resumeLink" placeholder="If? Resume Link" type="text" 
                     value={data.resumeLink}>Resume Link</InputFieldUpdate>
                    <InputFieldUpdate name="github" placeholder="If? Github Handle Username" type="text"
                    value={data.github} >Github</InputFieldUpdate>
                    <InputFieldUpdate name="linkedin" placeholder="If? Linkedin Handle Link" type="text"
                    value={data.linkedin} >LinkedIn</InputFieldUpdate>
                    <InputFieldUpdate name="twitter" placeholder="If? Twitter Handle Link" type="text"
                    value={data.twitter} >Twitter</InputFieldUpdate>
                    <InputFieldUpdate name="leetcode" placeholder="If? Leetcode Handle Username" type="text"
                    value={data.leetcode} >Leetcode</InputFieldUpdate>
                    <InputFieldUpdate name="codeforces" placeholder="If? Codeforces Handle Username" type="text"
                    value={data.codeforces} >Codeforce</InputFieldUpdate>
                    </>}
                    <button type='submit' style={{
                        cursor:"pointer"
                    }}>Consider My Update</button>
                </form>
                </div>
            ...
            <button className='btn_login' onClick={()=>navigate('/update')}>
